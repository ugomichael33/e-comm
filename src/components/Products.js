    ...
    <div className='products'>
        ...
        <div>
            <div className='flex relative w-[500px]'>
                    ...
                    <div className='ml-[535px] mt-80 w-8 h-8 rounded-2xl bg-white absolute fixed z-40' onClick={() => selectPreviousImage()}><img className='ml-2 mt-2' src={previous} /></div>
                    ...
                    <img className='h-[500px] w-[450px] fixed z-30 mt-24 ml-[550px] rounded-2xl' src={images[currImg].img} />
            </div>
            <div className='h-[200px] w-full flex fixed z-30 ml-[510px]'>
            {thumbnailImages.map((img, index) => 
                <img className='h-20 w-20 block mt-[620px] rounded-2xl ml-10 cursor-pointer' src={img} key={index} />
            )}
            </div>
        </div>
    </div>
